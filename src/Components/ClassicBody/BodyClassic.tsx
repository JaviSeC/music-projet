...
const songs = [
  {
    ...
    // duration: '2:42',
    Imagen: "https://img2.rtve.es/i/?w=1600&i=1667821299474.jpg",
    Audio:
  ...
  },
  {
    ...
    FilmName: "El golpe",
    // duration: '3:58',
    Imagen: "https://lavozenoffdotnet.files.wordpress.com/2017/02/cartel.jpg",
    Audio:
  ...
  },
  {
    ...
    Audio:
      "https://res.cloudinary.com/dhme3c8ll/video/upload/v1697011387/Miguel_Asins_Arb%C3%B3__Pasodoble_de__La_vaquilla__Luis_G%C2%AA_Berlanga_1985__0pVGEhPmbZA_m0jujo.mp3",
  },
  {
    Id_Songs: 8,
    ...
    Audio:
      "https://res.cloudinary.com/dhme3c8ll/video/upload/v1697011700/Me_quedo_contigo_-_Deprisa_deprisa_85nWERy0JdE_sgahf6.mp3",
  },
  {
    Id_Songs: 9,
    ...
    Audio:
      "https://res.cloudinary.com/dhme3c8ll/video/upload/v1697011387/El_Vaquilla_NZ-PWrXQocc_uwebzq.mp3",
  },
  {
    Id_Songs: 10,
    SongName: "Los Chunguitos",
    ...
    Audio:
      "https://res.cloudinary.com/dhme3c8ll/video/upload/v1697011529/los_chunguitos_soy_un_perro_callejero_4g3jSCqZxUQ_n6vsqj.mp3",
  },
];
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `https://localhost:7110/SongsControllers/GetSongsByCategory/GetSongsByCategory/${Id_Categories}`
        );
        if (response.ok) {
